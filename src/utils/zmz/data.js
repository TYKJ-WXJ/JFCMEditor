    ...
    btns: [
      {
        ...
        event: function () {
          ...
          msjstation.start();
          // let mainCamera = Msj3D.commonFunc.findObject('mainCamera');//主摄像机
      ...
      },
      {
        ...
        event: function () {
          let mainCamera = Msj3D.commonFunc.findObject('mainCamera'); // 主摄像机
          let doorRight = Msj3D.commonFunc.findObject('doorRight');
          mainCamera.lookAt(doorRight.position);
          new TWEEN.Tween(mainCamera.position).to({
            x: -300, y: 200, z: -700
          }, 5000).onComplete(function () {
            openRightDoor(Msj3D.commonFunc.findObject('doorRight'), function () {
              let cabinet3_1 = Msj3D.commonFunc.findObject('cabinet3_1');
