...
msj3D.prototype.createCube = function (_this, _obj) {
  ...
  let _x = _obj.x || 0, _y = _obj.y || 0, _z = _obj.z || 0;
...
914 msj3D.prototype.loadObj = function (_obj) {
  let jsloader = new THREE.JSONLoader();
  jsloader.load('test.json', function (geometry, materials) {
